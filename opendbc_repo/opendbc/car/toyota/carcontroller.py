...
def get_long_tune(CP, params):
  if CP.carFingerprint in TSS2_CAR:
    # 🌟 核心優化 2：高解析度無縫 PID 增益曲線 (消除階梯感)
    # 擴展為 7 個節點，讓起步的爆發力隨著車速像溜滑梯一樣極度平滑地遞減
    # 速度節點 (m/s):  0,   1.5,  3.0,  5.0,  8.0, 15.0, 35.0
    # 對應時速 (km/h): 0,   5.4, 10.8, 18.0, 28.8, 54.0, 80.0
    kiBP = [0.,   1.5,  3.0,  5.0,  8.0,  15.0, 22.2]
    
    # 增益曲線 (kiV):  平滑遞減，消滅折角頓挫
    kiV  = [1.5, 1.15, 0.85, 0.50, 0.35,  0.25,  0.15]
  else:
    kiBP = [0., 5., 35.]
    kiV = [3.6, 2.4, 1.5]
