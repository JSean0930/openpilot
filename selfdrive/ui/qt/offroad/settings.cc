...
TimpilotPanel::TimpilotPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("e2e_conditional",
                                  tr("Dynamic End-to-end Long"),
                                  tr("Automatically Turn On and Off End-to-end longitudinal (Extremely alpha), this will ignore the stock end-to-end settings"),
                                  "../assets/offroad/icon_road.png",
                                  this));
