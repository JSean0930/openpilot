...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if (self.topsng and self.CP.carFingerprint in EV_HYBRID_CAR and self.CP.smartDsu) or self.CP.carFingerprint in NO_STOP_TIMER_CAR or self.CP.enableGasInterceptor:
