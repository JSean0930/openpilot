...
ACCEL_CLIP_SLEW_NORMAL_MPS2_PER_S = 1.4        # 原本 0.05@20Hz ≈ 1.0 m/s^2 per sec
ACCEL_CLIP_SLEW_FAST_MPS2_PER_S = 2.5          # 允許快速反應，但限制下踩速度以配合平順緩煞
ACCEL_CLIP_FAST_LOW_SPEED_KPH = 40.0           # 低於此速可放寬（km/h）
