...
A_CRUISE_MIN_VALS = [-0.002, -0.10, -0.28, -0.6, -0.6]
A_CRUISE_MIN_BP =   [0.,     8.,    16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.6, 2.4, 1.95, 1.55, 1.25, .88, .68, .48, .33, .11]  # Sets the limits of the planner accel, PID may exceed
...
A_CRUISE_MAX_VALS_TOYOTA =   [2.0, 1.65, 1.5, 1.3, 1.1, 0.85, 0.68, 0.48, 0.33, 0.11]  # Sets the limits of the planner accel, PID may exceed
