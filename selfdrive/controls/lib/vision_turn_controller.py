...
_TURNING_LAT_ACC_TH = 3.6  # Lat Acc threshold to trigger turning turn state.

_LEAVING_LAT_ACC_TH = 3.3  # Lat Acc threshold to trigger leaving turn state.
_FINISH_LAT_ACC_TH = 3.1  # Lat Acc threshold to trigger end of turn cycle.
...
_TURNING_ACC_V = [1.2, 0.97, 0.955, 0.94, -0.1]  # acc value
